...
export const PlaylistSummaryViewer = React.memo<{
  playlistSummaryId: EntityId<"PlaylistSummary">;
}>(({ playlistSummaryId }) => {
  const { currentUserId } = useCurrentUser();

  const { entity: playlistSummary } = useEntity("PlaylistSummary", playlistSummaryId);
